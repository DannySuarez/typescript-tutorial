...
(function (Job) {
    ...
    Job[Job["FullStack"] = 1] = "FullStack";
    Job[Job["Developer"] = 2] = "Developer";
})(Job || (Job = {}));
var job = Job.FullStack;
var phone = 'Pixel';
var tablet = 3;
...
sayWord();
var sayAnotherWord = function sayAnotherWord(word) {
    if (word === void 0) {
        word = "hello";
    }
    var otherStuff = [];
...
//# sourceMappingURL=/src.a3dbd062.map